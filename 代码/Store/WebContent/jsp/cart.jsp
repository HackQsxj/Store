...
<html>
						...
						<tbody>
							...
							<tr class="active">
								...
								<td>
									...
									<!-- 使用js，增加一个删除确认 -->
									<a href="#" id="${item.product.pid }" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
	...
	<script>
		$(function(){
			//页面加载完毕后获取到delete，为其绑定点击事件
			$(".delete").click(function(){
				if(confirm("确认删除？")){
					//获取到被删除商品的id
					var pid = this.id;
					window.location.href="/Demo16Store/CartServlet?method=removeCartItem&pid="+pid;
				}
			});
			$(".clear").click(function(){
				if(confirm("确认清空购物车？")){
					window.location.href="/Demo16Store/CartServlet?method=clearCart";
				}
			});
		});
	</script>
