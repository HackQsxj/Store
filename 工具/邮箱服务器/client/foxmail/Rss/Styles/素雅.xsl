...
<xsl:template match="newspaper[@type='channel']">
	...
	<body>	
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tbody>			   			   
		  <tr>
		    <td height="50" align="center" valign="bottom" class="white_20"><table width="95%"  border="0" cellspacing="0" cellpadding="0">	
	  ...
	  <table width="100%" height="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="E2DFDF">
		...
		<xsl:for-each select="channel/item">				  		  		  
		  <tr>	
		      ...
		      <td align="center" valign="top" ><table width="100%"  border="0" cellpadding="0" cellspacing="0">
		        <tr>
		          <td height="52" align="center" valign="bottom" class="white_20"><table width="95%"  border="0" cellspacing="0" cellpadding="0">		         		    		          
		          <xsl:variable name="itemlink" select="link"/>	
